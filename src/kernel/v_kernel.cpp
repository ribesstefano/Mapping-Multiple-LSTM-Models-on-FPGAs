...
#pragma HLS DATAFLOW
  ...
  const int kNumTilesV = testv::params::H / testv::params::Tv;
  const int kStreamDepth_V = 8 + kNumTilesV * testv::params::N;
  ...
  testv::params::VectTvType y_buffer[testv::params::G][testv::params::N][kNumTilesV];
