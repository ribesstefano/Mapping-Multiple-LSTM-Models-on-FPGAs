...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:HlsAxisKernelU:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: HlsAxisKernelU_0, and set properties
  set HlsAxisKernelU_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:HlsAxisKernelU:1.0 HlsAxisKernelU_0 ]
  ...
  # Create instance: xu_dma, and set properties
  set xu_dma [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_dma:7.1 xu_dma ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net HlsAxisKernelU_0_xu_port [get_bd_intf_pins HlsAxisKernelU_0/xu_port] [get_bd_intf_pins xu_dma/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins HlsAxisKernelU_0/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins u_dma/S_AXI_LITE]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins xu_dma/S_AXI_LITE]
  connect_bd_intf_net -intf_net u_dma_M_AXIS_MM2S [get_bd_intf_pins HlsAxisKernelU_0/u_port] [get_bd_intf_pins u_dma/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net u_dma_M_AXI_MM2S [get_bd_intf_pins axi_mem_intercon_1/S00_AXI] [get_bd_intf_pins u_dma/M_AXI_MM2S]
  connect_bd_intf_net -intf_net x_dma_M_AXIS_MM2S [get_bd_intf_pins HlsAxisKernelU_0/x_port] [get_bd_intf_pins x_dma/M_AXIS_MM2S]
  ...
  assign_bd_address -offset 0x41E20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs xu_dma/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces u_dma/Data_MM2S] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces xu_dma/Data_S2MM] [get_bd_addr_segs processing_system7_0/S_AXI_HP2/HP2_DDR_LOWOCM] -force
